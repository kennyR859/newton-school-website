  ...
  ({ className, error, ...props }, ref) => {
    return (
      <div className="w-full">
        <textarea
          className={cn(
            "flex min-h-[120px] w-full rounded-xl border border-border bg-background/50 px-5 py-4 text-base ring-offset-background transition-all duration-200 resize-none",
